...
class ArtigosControllerTest < ActionController::TestCase
  ...
  test "should create artigo" do
    assert_difference('Artigo.count') do
      post :create, artigo: { body: @artigo.body, published_at: @artigo.published_at, title: @artigo.title }
    end
  ...
  test "should update artigo" do
    patch :update, id: @artigo, artigo: { body: @artigo.body, published_at: @artigo.published_at, title: @artigo.title }
    assert_redirected_to artigo_path(assigns(:artigo))
  end
